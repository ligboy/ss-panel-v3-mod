							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<p><a href="https://pan.baidu.com/s/1gdD24Cj"><i class="icon icon-lg">desktop_windows</i>&nbsp;Windows 下载 C# 版</a>，解压，然后下载<a href="/user/getpcconf">这个</a>，放到程序目录下，运行程序，选择一个合适的服务器，更新一下PAC为绕过国内IP，然后开启系统代理即可上网。</p>
										<p><a href="https://pan.baidu.com/s/1gdD24Cj"><i class="icon icon-lg">laptop_mac</i>&nbsp;Mac OS X下载这个</a>，安装，然后下载<a href="/user/getpcconf">这个</a>，运行程序，小飞机上右键 服务器列表 子菜单 的 “导入服务器配置文件...” 导入这个文件，然后选择一个合适的服务器，更新一下PAC，然后开启系统代理即可上网。</p>
										<p><i class="icon icon-lg">laptop_mac</i>&nbsp;iOS 下载<a href="/link/{$ios_token}">这个</a>，导入到 Surge 中，然后就可以随意切换服务器上网了。</p>
										<p><a href="https://pan.baidu.com/s/1gdD24Cj<i class="icon icon-lg">android</i>&nbsp;Android下载 Android 版</a>，安装，然后在手机上默认浏览器中点击<a id="android_add" href="{$android_add}">这个</a>，然后点击确定，批量添加完服务器，然后路由选择绕过大陆，右上角开启就可以上网了。</p>
									</div>
